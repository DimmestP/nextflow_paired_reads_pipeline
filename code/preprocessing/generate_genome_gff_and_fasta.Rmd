...
plasmid_features <- read_delim(here("./data/input/experiment_metadata/plasmid_features.csv"), ";")

RNA_seq_sample_names <- read_csv(here("./data/input/experiment_metadata/sample_to_construct_table.csv"))
...
genome_features <- read_tsv(here("data/input/genome_annotations/raw_annotation/reference_genome_annotation/longest_full-ORF_ypd_plus_other_fixed_UTR_length_transcripts.gff"), comment="#", col_names = GTF_COLNAMES) %>%
...
construct_fasta_file_names <- tibble(filepath = list.files(here("./data/input/genome_fasta/raw_fasta/linearized_plasmids"), full.names = TRUE)) %>%
...
genomic_fasta <- read_table(here("./data/input/genome_fasta/raw_fasta/saccharomyces_cerevisiae_R64-2-1_20150113_chrnames.fsa"))
